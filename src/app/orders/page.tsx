    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            <div className="mb-8 flex items-center gap-4">
                <div className="bg-orange-500/10 p-3 rounded-lg dark:bg-orange-500/20">
                    <Package className="h-8 w-8 text-orange-600 dark:text-orange-400" />
                </div>
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-orange-100">
                        My Orders
                    </h1>
                    <p className="text-muted-foreground mt-1 dark:text-orange-100/60">
            ...
            <Card className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg overflow-hidden">
                <CardHeader className="px-6 pt-6 pb-4 bg-gray-50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-800">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <CardTitle className="text-xl text-gray-900 dark:text-orange-100">
                                Order History
                            </CardTitle>
                            <CardDescription className="mt-1 text-gray-700 dark:text-orange-300/70">
                                {orders.length > 0 
                    ...
                    {orders.length === 0 ? (
                        <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
                            <div className="bg-gray-100 dark:bg-gray-800 rounded-full p-6 mb-6">
                                <Package className="h-16 w-16 text-gray-400 dark:text-orange-500" />
                            </div>
                            <h3 className="text-xl font-medium text-gray-900 dark:text-orange-100 mb-2">
                                No orders yet
                            </h3>
                            <p className="text-gray-500 dark:text-orange-200/70 max-w-md">
                            ...
                            <Table className="min-w-full">
                                <TableHeader className="bg-gray-50 dark:bg-gray-800/50">
                                    <TableRow className="border-b border-gray-200 dark:border-gray-800">
                                        <TableHead className="font-semibold text-gray-700 dark:text-orange-200 py-4 pl-6">
                                            Order ID
                                        </TableHead>
                                        <TableHead className="font-semibold text-gray-700 dark:text-orange-200">
                                            Date & Time
                                        </TableHead>
                                        <TableHead className="font-semibold text-gray-700 dark:text-orange-200">
                                            Payment
                                        ...
                                        <TableHead className="font-semibold text-gray-700 dark:text-orange-200 text-right">
                                            Amount
                                        </TableHead>
                                        <TableHead className="font-semibold text-gray-700 dark:text-orange-200 text-center">
                                            Action
                                        </TableHead>
                                    </TableRow>
                                </TableHeader>
                                    ...
                                    {orders.map((order: Order, index: number) => (
                                        <TableRow 
                                            ...
                                            className={`
                                                ...
                                                ${index === 0 ? 'bg-orange-50/20 dark:bg-orange-900/10' : ''}
                                            `}
                                        >
                                            <TableCell className="font-medium text-gray-900 dark:text-orange-100 py-4 pl-6">
                                                <span className="font-mono bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-md">
                                                    {truncateId(order._id)}
                                                </span>
                                            </TableCell>
                                            <TableCell className="text-sm text-gray-600 dark:text-orange-200/70">
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-sm font-medium text-gray-700 dark:text-orange-200/80">
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex items-center justify-end gap-1">
                                                    <IndianRupee className="h-4 w-4 text-gray-700 dark:text-orange-200/80" />
                                                    <span className="font-semibold text-gray-900 dark:text-orange-100">
                                            ...
                                            <TableCell className="text-center">
                                                <Link
                                                    ...
                                                    text-orange-500 hover:text-orange-400 focus-visible:outline-none
